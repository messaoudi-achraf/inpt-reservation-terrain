...
public class CustomExpandableListAdapterCancel extends BaseExpandableListAdapter {

    private Context mContext;
    private List<String> expandableListTitle;
    private HashMap<String, List<Reservation>> expandableListDetail;

    public CustomExpandableListAdapterCancel(Context mContext, List<String> expandableListTitle, HashMap<String, List<Reservation>> expandableListDetail) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            LayoutInflater inflater = (LayoutInflater)
                    this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.res_item_canceled,null);
