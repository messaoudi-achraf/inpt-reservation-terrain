...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public CustomExpandableListAdapter(Context mContext, List<String> expandableListTitle, HashMap<String, List<Reservation>> expandableListDetail) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Session.AnnulerRes(childPosition);
               // Etudiant.expandableListAdapter.registerDataSetObserver();
               Etudiant.expandableListView.invalidate();
               Etudiant.expandableListViewCancel.invalidate();
            }
        });
